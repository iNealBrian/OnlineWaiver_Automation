...
(async function addDependents() {
    ...
    // await driver.findElement(By.css("input[name='firstName2']")).sendKeys("Child DD");
    // await driver.findElement(By.css("input[name='lastName2']")).sendKeys("Child DD");
    ...
    // await driver.findElement(By.css("input[name='firstName3']")).sendKeys("Child EE");
    // await driver.findElement(By.css("input[name='lastName3']")).sendKeys("Child EE");
