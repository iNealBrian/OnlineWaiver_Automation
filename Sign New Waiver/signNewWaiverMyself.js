...
async function signNewWaiverMyself()
{
    ...
    // enter parent info
    await driver.findElement(By.id("firstName")).sendKeys("Parent BB");
    await driver.findElement(By.id("lastName")).sendKeys("Parent BB");
    ...
    var selectState = await driver.wait(until.elementLocated(By.id("stateinput")));
