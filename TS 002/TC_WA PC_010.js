...
async function verifyEmailAddress()
{
    ...
    await driver.wait(until.elementLocated(By.className("consent-option children")), 10000);
    await driver.findElement(By.className("consent-option children")).sendKeys(Key.RETURN);
