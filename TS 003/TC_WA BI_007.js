...
async function basicInfoVerification()
{
    ...
    await driver.findElement(By.id("birthMonth")).sendKeys("00");
    await driver.findElement(By.id("birthDay")).sendKeys("00");
    await driver.findElement(By.id("birthYear")).sendKeys("0000");
