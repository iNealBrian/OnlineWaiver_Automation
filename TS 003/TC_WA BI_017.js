...
async function signNewWaiverMyselfAndChild()
{
    ...
    await driver.findElement(By.css("label[for='female-child1']")).click();
    await driver.findElement(By.css("label[for='female-child1']")).click();
    ...
    await driver.findElement(By.css("label[for='female-child2']")).click();
    await driver.findElement(By.css("label[for='female-child2']")).click();
    ...
    await driver.findElement(By.css("label[for='female-child3']")).click();
    await driver.findElement(By.css("label[for='female-child3']")).click();
