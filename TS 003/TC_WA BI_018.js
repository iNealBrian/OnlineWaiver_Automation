...
async function signNewWaiverMyselfAndChild()
{
    ...
    await driver.findElement(By.css("label[for='other-child1']")).click();
    await driver.findElement(By.css("label[for='other-child1']")).click();
    ...
    await driver.findElement(By.css("label[for='other-child2']")).click();
    await driver.findElement(By.css("label[for='other-child2']")).click();
    ...
    await driver.findElement(By.css("label[for='other-child3']")).click();
    await driver.findElement(By.css("label[for='other-child3']")).click();
