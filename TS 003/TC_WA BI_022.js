...
async function signNewWaiverMyselfAndChild()
{
    ...
    await driver.findElement(By.css("label[for='other']")).click();
    ...
    await driver.findElement(By.css("input[name='childdobmm0']")).sendKeys("00");
    await driver.findElement(By.css("input[name='childdobdd0']")).sendKeys("00");
    await driver.findElement(By.css("input[name='childdobyyyy0']")).sendKeys("0000");
    await driver.findElement(By.css("label[for='other-child0']")).click();
    await driver.findElement(By.css("label[for='other-child0']")).click();
