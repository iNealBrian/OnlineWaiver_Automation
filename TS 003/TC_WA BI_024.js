...
async function signNewWaiverMyselfAndChild()
{
    ...
    // re-launch the browser and navigate to application
    var reLaunch = new Builder().forBrowser("chrome").build();
    await reLaunch.get("https://phqatesting.intercardinc.com/OnlineWaiver/home/NjAwMA%3D%3D/l/5");
